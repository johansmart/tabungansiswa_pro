<?php
	...
	$select_simpan="SELECT * FROM tb_simpan";
	...
	$Judul = "LAPORAN TRANSAKSI SIMPAN DANA";
	$Header= array(
		array("label"=>"No. Simpan", "length"=>40, "align"=>"L"),
		...
		array("label"=>"Jenis Simpan", "length"=>30, "align"=>"L"),
	);
