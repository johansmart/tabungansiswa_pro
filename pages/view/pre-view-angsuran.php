<section class="content-header">
    <h1>Pre<small>View Data Angsuran</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12 table-responsive">
			<div class="box box-primary">
				<div class="box-header">
					<span class="description" style="float: left;"><a href='./pages/cetak/cetak-angsuran-all.php' target='_blank' class='btn btn-warning pull-right'><i class='fa fa-print'></i> Print All</a></span>
					<span class="description" style="margin-right: 310px;float: right;"><strong><u>Atau</u> Masukan ID Member </strong></span>
					<div class="box-tools">
						<form action="home-admin.php?page=view-angsuran" class="form-horizontal" method="POST" enctype="multipart/form-data">
