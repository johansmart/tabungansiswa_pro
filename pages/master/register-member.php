<section class="content-header">
    <h1>Register<small>Member</small></h1>
    <ol class="breadcrumb">
	...
	$ceknik=mysql_num_rows (mysql_query("SELECT nik FROM tb_member WHERE nik='$_POST[nik]'"));
			...
			<div class='box box-primary'>
				<div class='register-box-body'>
					...
					<div class='row'>
						...
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-admin.php?page=form-register-member' class='btn btn-block btn-warning'>Back</button>
						</div>
					</div>
				</div>
			</div>";
		...
		if($query){
			echo "<div class='register-logo'><b>Register</b> Successful!</div>	
				<div class='register-box-body'>
					<p>Register Member Berhasil</p>
					<div class='row'>
						<div class='col-xs-8'></div>
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-admin.php?page=form-register-member' class='btn btn-primary btn-block btn-flat'>Next >></button>
						</div>
					</div>
				</div>";
		}
