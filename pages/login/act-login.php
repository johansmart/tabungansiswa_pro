	...
	if($op=="in"){
		...
		if(mysql_num_rows($sql)==1){
			...
			echo "<div class='register-logo'><b>Oops!</b> Login Failed.</div>	
				<div class='register-box-body'>
					<p>Rekening atau Password tidak sesuai. Silahkan diulang kembali.</p>
					<div class='row'>
						<div class='col-xs-8'></div>
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='masuk.php' class='btn btn-block btn-warning'>Back</button>
						</div>
					</div>
				</div>";
		}
